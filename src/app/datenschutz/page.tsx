...
export default function DatenschutzPage() {
  return (
    <div className="min-h-screen bg-warmgrau">
      {/* Hero */}
      <section className="py-16 bg-wuestennacht">
        <div className="container-custom">
          <h1 className="text-3xl md:text-4xl font-ww-bold text-white">Datenschutzerklärung</h1>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container-custom">
          <div className="max-w-3xl mx-auto bg-white rounded-fenster shadow-lg p-8 md:p-12">

            <div className="prose prose-lg max-w-none">

              <h2 className="text-2xl font-ww-bold text-wuestennacht mb-4">1. Datenschutz auf einen Blick</h2>

              <h3 className="text-xl font-ww-bold text-wuestennacht mb-3">Allgemeine Hinweise</h3>
              <p className="text-wuestennacht-light mb-6">
                Die folgenden Hinweise geben einen einfachen Überblick darüber, was mit Ihren personenbezogenen Daten passiert, wenn Sie diese Website besuchen. Personenbezogene Daten sind alle Daten, mit denen Sie persönlich identifiziert werden können. Ausführliche Informationen zum Thema Datenschutz entnehmen Sie unserer unter diesem Text aufgeführten Datenschutzerklärung.
              </p>

              <h3 className="text-xl font-ww-bold text-wuestennacht mb-3">Datenerfassung auf dieser Website</h3>
              ...
              <h2 className="text-2xl font-ww-bold text-wuestennacht mb-4 mt-8">2. Verantwortlicher</h2>
              <p className="text-wuestennacht-light mb-6">
              ...
              <h2 className="text-2xl font-ww-bold text-wuestennacht mb-4 mt-8">3. Datenerfassung auf dieser Website</h2>

              <h3 className="text-xl font-ww-bold text-wuestennacht mb-3">Cookies</h3>
              <p className="text-wuestennacht-light mb-6">
                Unsere Internetseiten verwenden so genannte „Cookies". Cookies sind kleine Textdateien und richten auf Ihrem Endgerät keinen Schaden an. Sie werden entweder vorübergehend für die Dauer einer Sitzung (Session-Cookies) oder dauerhaft (permanente Cookies) auf Ihrem Endgerät gespeichert. Session-Cookies werden nach Ende Ihres Besuchs automatisch gelöscht. Permanente Cookies bleiben auf Ihrem Endgerät gespeichert, bis Sie diese selbst löschen oder eine automatische Löschung durch Ihren Webbrowser erfolgt.
              </p>

              <h3 className="text-xl font-ww-bold text-wuestennacht mb-3">Server-Log-Dateien</h3>
              <p className="text-wuestennacht-light mb-4">
                Der Provider der Seiten erhebt und speichert automatisch Informationen in so genannten Server-Log-Dateien, die Ihr Browser automatisch an uns übermittelt. Dies sind:
              </p>
              <ul className="list-disc list-inside text-wuestennacht-light mb-6 space-y-1">
              ...
              <h3 className="text-xl font-ww-bold text-wuestennacht mb-3">Kontaktformular</h3>
              <p className="text-wuestennacht-light mb-6">
                Wenn Sie uns per Kontaktformular Anfragen zukommen lassen, werden Ihre Angaben aus dem Anfrageformular inklusive der von Ihnen dort angegebenen Kontaktdaten zwecks Bearbeitung der Anfrage und für den Fall von Anschlussfragen bei uns gespeichert. Diese Daten geben wir nicht ohne Ihre Einwilligung weiter. Die Verarbeitung dieser Daten erfolgt auf Grundlage von Art. 6 Abs. 1 lit. b DSGVO.
              </p>

              <h3 className="text-xl font-ww-bold text-wuestennacht mb-3">Anfrage per E-Mail, Telefon oder Telefax</h3>
              <p className="text-wuestennacht-light mb-6">
                Wenn Sie uns per E-Mail, Telefon oder Telefax kontaktieren, wird Ihre Anfrage inklusive aller daraus hervorgehenden personenbezogenen Daten (Name, Anfrage) zum Zwecke der Bearbeitung Ihres Anliegens bei uns gespeichert und verarbeitet. Diese Daten geben wir nicht ohne Ihre Einwilligung weiter.
              </p>

              <h2 className="text-2xl font-ww-bold text-wuestennacht mb-4 mt-8">4. Externe Dienste</h2>

              <h3 className="text-xl font-ww-bold text-wuestennacht mb-3">Cloudinary</h3>
              <p className="text-wuestennacht-light mb-6">
              ...
              <h3 className="text-xl font-ww-bold text-wuestennacht mb-3">Airtable</h3>
              <p className="text-wuestennacht-light mb-6">
              ...
              <h2 className="text-2xl font-ww-bold text-wuestennacht mb-4 mt-8">5. Ihre Rechte</h2>
              <p className="text-wuestennacht-light mb-4">
              ...
              <h3 className="text-xl font-ww-bold text-wuestennacht mb-3">Beschwerderecht bei der Aufsichtsbehörde</h3>
              <p className="text-wuestennacht-light mb-6">
              ...
              <h2 className="text-2xl font-ww-bold text-wuestennacht mb-4 mt-8">6. SSL- bzw. TLS-Verschlüsselung</h2>
              <p className="text-wuestennacht-light mb-6">
                Diese Seite nutzt aus Sicherheitsgründen und zum Schutz der Übertragung vertraulicher Inhalte, wie zum Beispiel Anfragen, die Sie an uns als Seitenbetreiber senden, eine SSL- bzw. TLS-Verschlüsselung. Eine verschlüsselte Verbindung erkennen Sie daran, dass die Adresszeile des Browsers von „http://" auf „https://" wechselt und an dem Schloss-Symbol in Ihrer Browserzeile.
              </p>

              <h2 className="text-2xl font-ww-bold text-wuestennacht mb-4 mt-8">7. Aktualität und Änderung dieser Datenschutzerklärung</h2>
              <p className="text-wuestennacht-light mb-6">
