  ...
  return (
    <div className="min-h-screen">
      ...
      <PageHero
        ...
        icon={Banknote}
        lines={[
          { text: 'ihre baufinanzierung' },
          { text: 'persönlich & unabhängig' },
        ]}
        subheadline="Als Wüstenrot-Partner biete ich Ihnen Zugang zu über 400 Banken und finde die optimale Finanzierung für Ihre Traumimmobilie in der Region Trier-Mosel."
        primaryCta={{
