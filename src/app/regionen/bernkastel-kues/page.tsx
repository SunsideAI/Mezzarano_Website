    ...
    <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="relative" data-aos="fade-left">
              <div className="relative aspect-[4/3] rounded-fenster overflow-hidden shadow-2xl">
                <Image
                  src="https://res.cloudinary.com/djqviyb2c/image/upload/w_800,q_85,f_auto/v1769251685/Bildschirmfoto_2026-01-24_um_11.48.04_asqrpt.png"
      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="border border-warmgrau rounded-fenster p-6 smooth-hover" data-aos="fade-up">
              <h3 className="text-lg font-bold font-ww-bold text-wuestennacht mb-3">Fachwerkhäuser</h3>
              <p className="text-wuestennacht-light text-sm">
            ...
            <div className="border border-warmgrau rounded-fenster p-6 smooth-hover" data-aos="fade-up" data-aos-delay="100">
              <h3 className="text-lg font-bold font-ww-bold text-wuestennacht mb-3">Häuser mit Moselblick</h3>
              <p className="text-wuestennacht-light text-sm">
                Einfamilienhäuser in Hanglagen mit Panoramablick auf den Fluss und die Weinberge –
                besonders gefragt und wertstabil.
              </p>
            </div>
            <div className="border border-warmgrau rounded-fenster p-6 smooth-hover" data-aos="fade-up" data-aos-delay="200">
              <h3 className="text-lg font-bold font-ww-bold text-wuestennacht mb-3">Ferienimmobilien</h3>
              <p className="text-wuestennacht-light text-sm">
                Ferienwohnungen und -häuser als Kapitalanlage mit Vermietungspotenzial in der
                beliebten Tourismusregion.
              </p>
            </div>
            <div className="border border-warmgrau rounded-fenster p-6 smooth-hover" data-aos="fade-up" data-aos-delay="300">
              <h3 className="text-lg font-bold font-ww-bold text-wuestennacht mb-3">Winzerhöfe & Weingüter</h3>
              <p className="text-wuestennacht-light text-sm">
      ...
      <section className="py-16 bg-wuestennacht text-white">
        <div className="container-custom">
          ...
          <p className="text-white/70 text-center max-w-2xl mx-auto mb-12" data-aos="fade-up" data-aos-delay="100">
