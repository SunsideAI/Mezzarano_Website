          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div data-aos="fade-right">
              <div className="flex items-center gap-2 text-primary-400 mb-4">
                ...
                <span className="font-medium">Bitburg & Eifel</span>
              </div>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
                Ihr Immobilienmakler in Bitburg
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link href="/immobilien?ort=Bitburg" className="btn-outline">
            ...
            <div className="relative" data-aos="fade-left">
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl">
                <Image
                  ...
                  priority
                  placeholder="blur"
                  blurDataURL="https://res.cloudinary.com/djqviyb2c/image/upload/w_20,q_20,e_blur:500,f_auto/v1770805358/Bittburg_tejpzq.png"
                />
              </div>
