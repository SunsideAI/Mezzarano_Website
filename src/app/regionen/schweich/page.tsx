    ...
    <>
      ...
      <section className="py-16 bg-white">
        <div className="container-custom text-center" data-aos="fade-up">
          <h2 className="text-2xl font-bold font-ww-bold text-wuestennacht mb-8">
            Auch aktiv in der Region
          </h2>
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/regionen/trier" className="px-6 py-3 bg-warmgrau rounded-fenster hover:bg-warmgrau transition-colors text-wuestennacht-light">
              Trier
            </Link>
            <Link href="/regionen/hermeskeil" className="px-6 py-3 bg-warmgrau rounded-fenster hover:bg-warmgrau transition-colors text-wuestennacht-light">
              Hermeskeil
            </Link>
            <Link href="/regionen/bernkastel-kues" className="px-6 py-3 bg-warmgrau rounded-fenster hover:bg-warmgrau transition-colors text-wuestennacht-light">
              Bernkastel-Kues
            </Link>
          </div>
        </div>
