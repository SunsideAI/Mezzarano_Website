...
export const metadata: Metadata = {
  title: 'Immobilienmakler Wittlich | Sandro Mezzarano | Wüstenrot Immobilien',
  description: 'Ihr Immobilienexperte in Wittlich. Sandro Mezzarano von Wüstenrot Immobilien berät Sie kompetent beim Kauf, Verkauf und der Vermietung von Immobilien in der Moseleifel.',
  keywords: 'Immobilienmakler Wittlich, Haus kaufen Wittlich, Wohnung mieten Wittlich, Wüstenrot Immobilien, Immobilienbewertung Wittlich',
  openGraph: {
    title: 'Immobilienmakler Wittlich | Wüstenrot Immobilien',
    description: 'Sandro Mezzarano - Ihr lokaler Immobilienexperte für Wittlich und die Moseleifel.',
    type: 'website',
    locale: 'de_DE',
  },
}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div data-aos="fade-right">
              <div className="flex items-center gap-2 text-primary-400 mb-4">
                ...
                <span className="font-medium">Wittlich & Moseleifel</span>
              </div>
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-6 leading-tight">
                Ihr Immobilienmakler in Wittlich
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link href="/immobilien?ort=Wittlich" className="btn-outline">
            ...
            <div className="relative" data-aos="fade-left">
              <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl">
                <Image
                  ...
                  priority
                  placeholder="blur"
                  blurDataURL="https://res.cloudinary.com/djqviyb2c/image/upload/w_20,q_20,e_blur:500,f_auto/v1770805357/Wittlich_c5qqd9.png"
                />
              </div>
      ...
      <section className="bg-primary-500 text-white py-4">
        <div className="container-custom flex flex-wrap justify-center gap-6 md:gap-12 text-sm md:text-base">
          ...
          <div className="flex items-center gap-2">
            ...
            <span>Büro in Hermeskeil – 30 Min. von Wittlich</span>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-secondary-900 text-white">
        <div className="container-custom">
          <h2 className="text-3xl font-bold mb-8 text-center" data-aos="fade-up">
            Immobilien in der Region Wittlich
          </h2>
          <p className="text-gray-300 text-center max-w-3xl mx-auto mb-12" data-aos="fade-up" data-aos-delay="100">
            Neben Wittlich betreue ich auch Immobilien in den umliegenden Ortschaften
            und Gemeinden der Moseleifel.
          </p>
          ...
          <div className="text-center mt-8">
            <Link href="/regionen/bernkastel-kues" className="btn-primary">
              Auch aktiv in Bernkastel-Kues
      ...
      <section className="py-16 bg-primary-500">
        <div className="container-custom text-center" data-aos="fade-up">
          <h2 className="text-3xl font-bold text-white mb-6">
            Bereit für Ihr Immobilienprojekt in Wittlich?
          </h2>
