          ...
          >
            <span className="flex flex-col items-start gap-0">
              {slides[currentSlide].lines.map((line, index) => (
                <span
                  key={index}
                  className={`inline-block w-fit whitespace-nowrap bg-white px-4 py-1 md:px-5 md:py-2 text-2xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-none lowercase ${
              ...
              {/* Brand wüstenrot */}
              <span className="inline-block w-fit whitespace-nowrap bg-white px-4 py-1 md:px-5 md:py-2 text-2xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-none text-wuestenrot">
                wüstenrot
              </span>
            </span>
          </h1>
